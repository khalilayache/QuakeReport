...
*/
    ...
    private static List<Earthquake> extractFeatureFromJson(String earthquakeJSON){
        ...
        try {
            ...
            Log.e("QuakeReport ERROR","Problem parsing the earthquake JSON results", e);
        }
    ...
    private static URL createURL(String stringURL){
        ...
        try{
            ...
            Log.e("QuakeReport ERROR","Problem building the URL", e);
        }
        return url;
    }
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try{
            ...
            if (urlConnection.getResponseCode() == 200){
                ...
                Log.e("QuakeReport ERROR","Error response code: " + urlConnection.getResponseCode());
            }

        } catch (IOException e) {
            Log.e("QuakeReport ERROR","Problem retrieving the earthquake JSON results", e);
        }
        finally {
    ...
    public static List<Earthquake> fetchEarthquakeData (String requestURL){
        ...
        try{
            ...
            Log.e("QuakeReport ERROR","Problem making the HTTP request", e);
        }
